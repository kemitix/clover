...
@BackCover
@ApplicationScoped
public class ReprintScienceFictionYearStories
    ...
    @Getter
    private final Section.Label sectionLabel = Section.Label.REPRINT_SCIENCE_FICTION;
    ...
    protected String getHeader() {
        return "The %s Stories / %s".formatted(
                issueConfig.getDate(),
                Section.Label.REPRINT_SCIENCE_FICTION.getValue());
    }
    ...
    protected List<? extends IssueStory> getStories() {
        return issueConfig.getStories(Section.Label.REPRINT_SCIENCE_FICTION);
    }
