...
@BackCover
@ApplicationScoped
public class OriginalScienceFictionYearStories
    ...
    @Getter
    private final Section.Label sectionLabel = Section.Label.SCIENCE_FICTION;
    ...
    protected String getHeader() {
        return "The Bonus Stories / %s".formatted(
                Section.Label.SCIENCE_FICTION.getValue());
    }
